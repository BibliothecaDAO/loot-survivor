...
mod Game {
    ...
    use survivor::{
        ...
        constants::{
            ...
            adventurer_constants::{
                ...
                OBSTACLE_CRITICAL_HIT_CHANCE, STAT_UPGRADES_PER_LEVEL
            }
        },
    ...
    use combat::{
        ...
        constants::{CombatEnums::{Slot, Tier, Type}, CombatSettings::{STRENGTH_DAMAGE_BONUS}}
    };
    ...
    impl Game of IGame<ContractState> {
        ...
        fn stat_upgrades_per_level(self: @ContractState) -> u8 {
            STAT_UPGRADES_PER_LEVEL
        }
        fn beast_special_name_unlock_level(self: @ContractState) -> u8 {
            BEAST_SPECIAL_NAME_LEVEL_UNLOCK
        }
        fn item_xp_multiplier_beasts(self: @ContractState) -> u8 {
            ITEM_XP_MULTIPLIER_BEASTS
        }
        fn item_xp_multiplier_obstacles(self: @ContractState) -> u8 {
