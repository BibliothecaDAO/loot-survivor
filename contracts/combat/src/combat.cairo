...
use super::constants::{
    ...
    CombatSettings::{
        ...
        ARMOR_TIER_DAMAGE_MULTIPLIER, ELEMENTAL_DAMAGE_BONUS, LEVEL_MULTIPLIER,
        STRENGTH_DAMAGE_BONUS, MINIMUM_BASE_DAMAGE
    }
};
    ...
    use combat::{
        ...
        constants::{
            ...
            CombatSettings::{
                ...
                LEVEL_MULTIPLIER, MINIMUM_BASE_DAMAGE, STRENGTH_DAMAGE_BONUS
            }
        }
    };
