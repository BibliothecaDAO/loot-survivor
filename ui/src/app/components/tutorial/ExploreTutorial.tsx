  ...
  return (
    <div className="flex flex-col gap-5 uppercase items-center text-center h-full">
      ...
      <ul className="text-sm sm:text-lg">
        <li>
          <strong>1. Encountering a Beast:</strong> There are 75 distinct types of beasts, each with a fixed elemental type and tier. The level and health of the beasts will vary and scale based on the adventurer's level. When encountering a beast, it will attempt to ambush and attack before you have a chance to react. Your chance change of avoiding this ambush is based on your Adventurer's Wisdom. Defeating provides gold and xp for your adventurer and items, with stronger beasts yielding more substantial gold and xp. 
        </li>

        <li>
          <strong>2. Encountering an Obstacle:</strong> The game features 75 unique obstacles, each with a fixed elemental type and tier. The level of the Obstacles will vary and scale based on the adventurer's level. Adventurer's will either dodge an obstacle or suffer damage with the chance of dodging it based on the Adventurer's Intelligence.
        </li>

        <li>
          <strong>3. Discovering Gold and Health:</strong> The amount of gold and health discovered will vary and scale with your adventurer's level.
        </li>
      </ul>
    </div>
  );
