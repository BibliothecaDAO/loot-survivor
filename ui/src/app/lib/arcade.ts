...
export class ArcadeConnector extends Connector {
    ...
    async initEventListener(accountChangeCb: AccountChangeEventHandler): Promise<void> {
        return Promise.resolve();
    }

    async removeEventListener(accountChangeCb: AccountChangeEventHandler): Promise<void> {
        return Promise.resolve();
    }
