...
export const prologue = "In a sunless world teetering on the brink of destruction, haunted by horrific beasts and spectral entities, humanity clings to an ancient prophecy of a chosen one bringing balance. You, propelled by this prophecy and the lessons of past lives, confront monstrous challenges and unravel cryptic mysteries, poised to either restore hope or be consumed by encroaching darkness."
