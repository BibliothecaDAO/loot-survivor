...
export const prologue = "In a world devoid of sun, teetering on annihilation, humanity clings to an archaic prophecy of a savior restoring balance.";
export const chapter1 = "An adventurer stirs from slumber in the cold, dank cave. Disoriented, they scour the darkness, the only sound a dripping echo and the biting whisper of wind.";
export const chapter2 = "Where? How? Water whispers nearby. They move, reaching through the mist. Suddenly, a fountain materializes, an ethereal sentinel obscured by the swirling vapor.";
export const chapter3 = "Intrigued, they draw closer, their form dancing on the water's surface. Four oddities lie within - a wand, a book, a club, and a sword. Selecting one, the others dissolve, leaving an unnerving hush in their wake.";
export const chapter4 = "They find golden coins in their pocket, glimmering in the dim light - an enigma wrapped in the shroud of the unexpected.";
export const battle = "A beast lurks in the shadow, the time for battle is nigh.";
...
export const contracts = {
  ...
  goerli: {
    game: "0x072200bec469dfd77b3c92ace944cc0ec018074ae3d8868b5c69aeabed29b336",
    lords_erc20_mintable:
