...
export const prologue = "In a sunless world teetering on the brink of destruction, humanity clings to an ancient prophecy of a chosen one bringing balance."
export const chapter1 = "In the chilling embrace of the cave, an adventurer stirs awake. Confused, disoriented, their eyes dart across the darkness, searching. The echo of water dripping and the chilling wind fill the air."
